...
class CustomAlertController: UIViewController {
    ...
    private let titleLabel = PTLabel(textAlignment: .center, fontSize: 20)
    private let descriptionLabel = PTDescriptionLabel(textAlignment: .center)
    private let actionButton = PTButton(backgroundColor: .systemPink, title: "Ok")
